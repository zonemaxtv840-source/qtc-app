...
# ============================================
# CSS ACTUALIZADO (Cards y Tabs en Negro)
# ============================================
st.markdown("""
<style>
    /* Fondo principal */
    ...
    /* Cards de resultados - Fondo blanco y tipografía negra */
    .result-card {
        background: #ffffff;
        border-radius: 16px;
        padding: 1rem;
    ...
    /* Forzar texto negro en cards y todos sus hijos */
