...
# ============================================
# CONSTANTES Y CONFIGURACIÓN (LIMPIAS)
# ============================================
...
def generar_excel(items: List[Dict], cliente: str, ruc: str) -> bytes:
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        for i, header in enumerate(headers): ws.write(5, i, header, fmt_header)
...
with tab_cotizacion:
    if not st.session_state.catalogos:
        ...
        if st.button("🚀 PROCESAR", use_container_width=True, type="primary") and pedidos:
            if not col_precio:
                ...
                with st.spinner("🔍 Procesando..."):
                    ...
                    # Opcional: limpiar acumulada tras procesar exitosamente
                    # st.session_state.cotizacion_acumulada = {}
        ...
        if st.session_state.resultados:
            ...
            }, use_container_width=True, hide_index=True, key="ajuste_editor")
...
with tab_buscar:
    ...
    if not st.session_state.catalogos:
        ...
        # ✅ FIX: Búsqueda solo con botón (elimina delay)
                ...
                for cat in st.session_state.catalogos:
                    ...
                    for _, row in df[mask].iterrows():
                        ...
                        if precio_seleccionado:
                            ...
                            if col_precio_real: precio = corregir_numero(row[col_precio_real])
                        ...
                        resultados_busqueda.append({
                            ...
                            'Precio': precio, 'Stock_Total': stock_total, 'Stock_Detalle': stock_columnas
                        })
            if resultados_busqueda:
                ...
                for res in resultados_busqueda:
                    ...
                    if st.session_state.tipo_cotizacion == ModoCotizacion.GENERAL and res.get('Stock_Detalle'):
                        badge_detalle = '<br>'.join([f'📦 Total: {d["total"]} | 🔒 Comp: {d["comprometido"]} | 📋 Sol: {d["solicitado"]} | ✅ Disp: {d["disponible"]}' for d in res['Stock_Detalle'].values()])
                    ...
                    # ✅ FIX: Cantidad directa (evita duplicación en reruns)
        ...
        if st.session_state.productos_seleccionados:
            ...
            # ✅ FIX: Transferencia atómica y acumulable
